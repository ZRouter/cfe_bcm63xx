...
{
	uint16 numChp;
#define BCM3380_IUDMA_REGS_NUM_CHP_MASK     0x0f00
#define BCM3380_IUDMA_REGS_NUM_CHP_SHIFT    8
   uint16 ctrlConfig;
#define BCM3380_IUDMA_REGS_CTRLCONFIG_MASTER_EN        0x0001
#define BCM3380_IUDMA_REGS_CTRLCONFIG_FLOWC_CH1_EN     0x0002
#define BCM3380_IUDMA_REGS_CTRLCONFIG_FLOWC_CH3_EN     0x0004
...
typedef struct PcmIudmaChannelCtrl
{
   uint16 reserved1;
	uint16 config;
#define BCM3380_IUDMA_CONFIG_ENDMA       0x0001
#define BCM3380_IUDMA_CONFIG_PKTHALT     0x0002
#define BCM3380_IUDMA_CONFIG_BURSTHALT   0x0004

	uint16 reserved2;
	uint16 intStat;
#define BCM3380_IUDMA_INTSTAT_BDONE   0x0001
#define BCM3380_IUDMA_INTSTAT_PDONE   0x0002
#define BCM3380_IUDMA_INTSTAT_NOTVLD  0x0004
#define BCM3380_IUDMA_INTSTAT_MASK    0x0007
#define BCM3380_IUDMA_INTSTAT_ALL     BCM3380_IUDMA_INTSTAT_MASK

	uint16 reserved3;
	uint16 intMask;
#define BCM3380_IUDMA_INTMASK_BDONE   0x0001
#define BCM3380_IUDMA_INTMASK_PDONE   0x0002
#define BCM3380_IUDMA_INTMASK_NOTVLD  0x0004

	uint16 reserved4;
	uint16 maxBurst;
#define BCM3380_IUDMA_MAXBURST_SIZE 16 /* 32-bit words */
...
#define BCM3380_IUDMA_STRAM_DESC_RING_OFFSET 0x3fff
...
#define BCM3380_MAX_PCM_DMA_CHANNELS 6

typedef struct PcmIudma
{
   PcmIudmaRegisters regs;
   uint16 reserved1[114];
   PcmIudmaChannelCtrl ctrl[BCM3380_MAX_PCM_DMA_CHANNELS];
   uint16 reserved2[80];
   PcmIudmaStateRam stram[BCM3380_MAX_PCM_DMA_CHANNELS];
