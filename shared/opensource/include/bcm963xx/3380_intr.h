...
#define INTERRUPT_ID_EMAC2               (INTERNAL_ISR_TABLE_OFFSET + 6)
...
#define INTERRUPT_ID_EMAC2_RX_DMA        (INTERNAL_ISR_TABLE_OFFSET + 17)
#define INTERRUPT_ID_EMAC2_TX_DMA        (INTERNAL_ISR_TABLE_OFFSET + 18)
#define INTERRUPT_ID_ATM                 (INTERNAL_ISR_TABLE_OFFSET + 19)
#define INTERRUPT_ID_EXTERNAL_4          (INTERNAL_ISR_TABLE_OFFSET + 20)
#define INTERRUPT_ID_EXTERNAL_5          (INTERNAL_ISR_TABLE_OFFSET + 21)
#define INTERRUPT_ID_PCM                 (INTERNAL_ISR_TABLE_OFFSET + 22)
#define INTERRUPT_ID_PCM_RX_DMA          (INTERNAL_ISR_TABLE_OFFSET + 23)
#define INTERRUPT_ID_PCM_TX_DMA          (INTERNAL_ISR_TABLE_OFFSET + 24)
#define INTERRUPT_ID_EXTERNAL_0          (INTERNAL_ISR_TABLE_OFFSET + 25)
#define INTERRUPT_ID_EXTERNAL_1          (INTERNAL_ISR_TABLE_OFFSET + 26)
#define INTERRUPT_ID_EXTERNAL_2          (INTERNAL_ISR_TABLE_OFFSET + 27)
#define INTERRUPT_ID_EXTERNAL_3          (INTERNAL_ISR_TABLE_OFFSET + 28)
#define INTERRUPT_ID_ADSL                (INTERNAL_ISR_TABLE_OFFSET + 29)
#define INTERRUPT_ID_DG                  (INTERNAL_ISR_TABLE_OFFSET + 30)
#define INTERRUPT_ID_MPI                 (INTERNAL_ISR_TABLE_OFFSET + 31)
